...
class ShoebotTestCase(TestCase):
    ...
    def run_code(self, code, outputfile, kwargs=None, windowed=False, namespace=None):
        """
        ...
        bot.run(code, **kwargs or {})

    def run_filename(self, filename, outputfile, kwargs=None, windowed=False, namespace=None):
        """
